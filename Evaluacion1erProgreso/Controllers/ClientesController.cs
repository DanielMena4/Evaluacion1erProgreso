...
namespace Evaluacion1erProgreso.Controllers
{
    public class ClientesController : Controller
    {
        private readonly Evaluacion1erProgresoContext _context;

        public ClientesController(Evaluacion1erProgresoContext context)
        {
            _context = context;
        }
